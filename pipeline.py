"""
Production Machine Learning Pipeline for Automotive Resale Valuation & Used Car Pricing Engine.
...
def train_and_evaluate(csv_path: str = "used_cars_powerful.csv"):
...
def main():
    parser = argparse.ArgumentParser(description="Automotive Resale Valuation & Used Car Pricing Engine CLI")
    parser.add_argument("--data", type=str, default="used_cars_powerful.csv", help="Path to CSV dataset")
